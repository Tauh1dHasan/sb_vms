...
--
-- Host: localhost
-- Generation Time: Sep 23, 2021 at 06:09 AM
...
(1, 2, 2, 'Rayhan', 'Zaman', 'rayhan-zaman', 1, '2021-09-22', 1, 1, 5, '01521449100', 'rayhan.zaman@sebpo.com', 'Dhaka', 'employee1632294289.jpg', 1234567891234567, 1234567891234567, 1234567891234567, '10:30', '18:30', NULL, '2021-09-22 07:04:49', NULL, NULL, 1, 1),
(2, 5, 2, 'Gazi Alim', 'Al Razy', 'gazi alim-al razy', 1, '2021-09-22', 3, 1, 1, '01711924545', 'rayhan.zaman@sebpo.com', 'Dhaka', 'employee1632316311.jpg', 1234567891234567, 1234567891234567, 1234567891234567, '10:08', '19:00', NULL, '2021-09-22 13:11:51', NULL, NULL, 1, 1),
(3, 6, 2, 'Shirajul', 'Islam', 'shirajul-islam', 1, '1995-09-15', 12345, 3, 10, '78945612378', 'any@gmail.com', NULL, 'employee1632316656.jpg', NULL, NULL, NULL, '10:16', '22:16', NULL, '2021-09-22 13:17:36', NULL, NULL, 1, 1),
(4, 7, 2, 'Ashraful', 'Alam', 'ashraful-alam', 1, '1994-02-01', 2274, 1, 3, '01672548372', 'ashraful@sebpo.com', 'Sector-4, Uttara, Bangladesh', 'employee1632317113.jpg', 19949329508000043, NULL, NULL, '10:30', '19:30', NULL, '2021-09-22 13:25:13', NULL, NULL, 1, 1),
(5, 8, 2, 'Didarul', 'Islam', 'didarul-islam', 1, NULL, 1234, 1, 2, '01742592926', 'didarul.islam@sebpo.com', NULL, NULL, NULL, NULL, NULL, '10:00', '19:00', NULL, '2021-09-22 13:29:02', NULL, NULL, 1, 1);
...
CREATE TABLE `meetings` (
  ...
  `purpose_describe` text COLLATE utf8mb4_unicode_ci,
...
(1, 3, 1, 1, 1, 'test', '2021-09-22 13:26:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0),
...
CREATE TABLE `settings` (
  ...
  `factory_address` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `users` (`user_id`, `username`, `password`, `user_type_id`, `is_approved`, `entry_datetime`, `modified_datetime`) VALUES
(1, '01234567890', '$2y$10$3P3lzrKVNNbjI9tEHB2DEOON.lz0UE28GUbMt4WOZ.lZpv7TUbrSi', 1, 1, '2021-09-22 07:04:49', NULL),
(2, '01521449100', '$2y$10$3P3lzrKVNNbjI9tEHB2DEOON.lz0UE28GUbMt4WOZ.lZpv7TUbrSi', 2, 1, '2021-09-22 07:04:49', NULL),
(3, '01955181028', '$2y$10$IHUpizB/DFRdmU78leYlUemaBue7YSysC7rNhBNu84Iondj/hT3FS', 4, 1, '2021-09-22 07:16:00', NULL),
(4, '01987456321', '$2y$10$KZfiHa8Fm5/Bfuw.kY2i5.ZlBPaPXqYnsCPBpF28k2glPdyDO7X9C', 4, 1, '2021-09-22 13:01:35', NULL),
(5, '01711924545', '$2y$10$8BN.jNKHDqgT2PO0RlH6pulFKw7OKFr5.cBwZmaEdtr6YBe2HXP9q', 2, 1, '2021-09-22 13:11:51', NULL),
(6, '78945612378', '$2y$10$2mNAgIkwhVlQk4ivdCpGkehKToE1/06ak3kuwHu9Om2VUb5As/O5K', 2, 1, '2021-09-22 13:17:36', NULL),
(7, '01672548372', '$2y$10$Zt9J91PuCVDfJ.e1MHJ8/O0XSds7TcSd7PTWUv4KMpakDjtMjuccC', 2, 1, '2021-09-22 13:25:13', NULL),
(8, '01742592926', '$2y$10$SmM5InZvRoUqv.5Wc2.WqO.wrTgiwTbo7mgP88tnWi3ic6iyzmgQC', 2, 1, '2021-09-22 13:29:02', NULL),
(9, '01794356471', '$2y$10$xmh555mZKaX5ObAKCYvWP.IQLcnqxB.SboV.WCzu0Y02KJ5tyH.Y.', 4, 1, '2021-09-22 13:33:09', NULL),
(10, '01914594422', '$2y$10$ytxieMrF68H98OQnnAjjM.iJvL.6MMNDCKh7CSEvu0RE2yRudAD4u', 4, 1, '2021-09-22 13:35:17', NULL);
...
INSERT INTO `visitors` (`visitor_id`, `user_id`, `visitor_type`, `first_name`, `last_name`, `slug`, `gender`, `dob`, `mobile_no`, `email`, `address`, `profile_photo`, `nid_no`, `passport_no`, `driving_license_no`, `entry_user_id`, `entry_datetime`, `modified_user_id`, `modified_datetime`, `visitor_status`) VALUES
(1, 3, 1, 'Rayhan', 'Zaman', 'rayhan-zaman', 1, '2021-09-22', 1955181028, 'rayhan.zaman@sebpo.com', 'Dhaka', 'visitor1632294960.jpg', 1234567891234567, 1234567891234567, 1234567891234567, NULL, '2021-09-22 07:16:00', NULL, NULL, 1),
(2, 4, 2, 'Tauhid', 'Hasan', 'tauhid-hasan', 1, '1990-09-22', 1234567890, 'tauhid.hasan@sebpo.com', 'New visitor 001 address', 'visitor1632315695.jpg', 123456789012345, 123456789012345, 123456789012345, NULL, '2021-09-22 13:01:35', NULL, NULL, 1),
(3, 9, 2, 'Ashraful', 'Alam', 'ashraful-alam', 1, '1994-02-01', 1794356471, 'ashraful@sebpo.com', 'Holding No- 903, Village: Alowa Bhabani', 'visitor1632317589.jpg', 19949329508000043, NULL, NULL, NULL, '2021-09-22 13:33:09', NULL, NULL, 1),
(4, 10, 2, 'Romana', 'Tanzim', 'romana-tanzim', 2, NULL, 1914594422, 'didar.austcse@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, '2021-09-22 13:35:17', NULL, NULL, 1);
