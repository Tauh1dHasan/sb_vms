                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('visitor.profile') }}">Profile</a></li>
                        ...
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('visitor.editProfile', $visitor->user_id) }}" class="mt-2 edit-profile"> 
                                                ...
                                                <div class="form-group row mb-4">
                                                    <div class="col-lg-12 text-center" style="padding-left: 0">
                                                        <label for="employee" class="col-form-label" style="font-size: 1.25rem; font-weight: 400">
                                                            ...
                                                            @else
                                                                <img style="max-width: 400px" src="{{ asset('backend/img/no.jpg') }}" alt="User Profile Photo">
                                                            @endif
                                                        </label>
                                                    </div>
                                                </div>
