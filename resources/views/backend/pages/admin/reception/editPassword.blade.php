                ...
                <div class="col-md-12"> 
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Edit Receptionist Password</span></li>
                        </ol>
                    </nav>
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <div class="widget widget-card-four" style="padding-left: 0"> 
                                <div class="w-header">
                                    <div class="w-info">
                                        <h6 class="value">Edit Receptionist Password</h6>
                                    </div>
                                </div>
                            </div>
                            @include('backend.partials.message')
                            <form class="" action="{{ route('admin.receptionist.updatePassword', $employee->employee_id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
