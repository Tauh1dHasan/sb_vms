                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Approved Visitor</span></li>
                        </ol>
                    </nav>
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <div class="widget widget-card-four" style="padding-left: 0"> 
                                <div class="w-header">
                                    <div class="w-info">
                                        <h6 class="value">Approved Visitor</h6>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"> 
                                                    ...
                                                    @elseif($visitor->visitor_status == 2)
                                                        <span class="shadow-none badge badge-danger">Blocked</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2" style="will-change: transform;">
                                                            ...
                                                            <a class="dropdown-item action-edit" href="{{ route('admin.visitor.edit', $visitor->visitor_id) }}">
                                                            ...
                                                            @if ($visitor->visitor_status == 0)
                                                                <a class="dropdown-item action-view" href="{{route('admin.visitor.approve', $visitor->visitor_id)}}">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line></svg>Approve
                                                                </a>
                                                                <a class="dropdown-item action-delete" onclick="return confirm('Are you sure want to Block this visitor ?')" href="{{route('admin.visitor.block', $visitor->visitor_id)}}">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>Block
                                                                </a>
                                                            @elseif($visitor->visitor_status == 1)
                                                                <a class="dropdown-item action-delete" onclick="return confirm('Are you sure want to Block this visitor ?')" href="{{route('admin.visitor.block', $visitor->visitor_id)}}">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>Block
