@extends('backend.layouts.master')
    ...
    <nav class="breadcrumb-one" aria-label="breadcrumb">
        <ol class="breadcrumb" style="background: none; padding: 0;">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.appointment.appointVisitor')}}">Appoint Visitor</a></li>
        </ol>
    </nav>
                        ...
                        <div class="col-lg-12 col-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <form action="{{ route('admin.appointment.placeAnAppointment') }}" method="post">
                                        @csrf
                                        {{-- needed hidden field --}}
                                        <input type="hidden" name="visitor_id" value="{{ $visitor_id }}">

                                        <div class="form-group mb-4">
                                            <select name="employee_id" id="employee_id_from_admin" class="form-control"></select>
                                        </div>
