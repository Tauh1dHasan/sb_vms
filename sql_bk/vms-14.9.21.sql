...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2021 at 02:47 PM
...
CREATE TABLE `employees` (
  ...
  `entry_datetime` varchar(255) DEFAULT NULL,
  `modified_user_id` int(11) DEFAULT NULL,
  `modified_datetime` varchar(255) DEFAULT NULL,
...
CREATE TABLE `failed_logins` (
  ...
  `failed_login_datetime` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `login_activitys` (
  ...
  `logout_datetime` varchar(100) NOT NULL,
...
CREATE TABLE `login_attempts` (
  ...
  `attempt_datetime` varchar(100) NOT NULL,
  `attempt_ip` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `login _lockdowns` (
  ...
  `lockdown_datetime` varchar(100) NOT NULL,
  `release_datetime` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `meetings` (
  ...
  `purpose_describe` text DEFAULT NULL,
  `meeting_datetime` datetime NOT NULL,
  `meeting_start_time` varchar(100) DEFAULT NULL,
  `meeting_end_time` varchar(100) DEFAULT NULL,
  `entry_user_id` int(11) DEFAULT NULL,
  `entry_datetime` varchar(255) DEFAULT NULL,
  `modified_user_id` int(11) DEFAULT NULL,
  `modified_datetime` varchar(255) DEFAULT NULL,
...
CREATE TABLE `settings` (
  ...
  `primary_mbl` varchar(100) NOT NULL,
  `alt_mbl` varchar(100) DEFAULT NULL,
...
CREATE TABLE `visitor_pass` (
  ...
  `visitor_id` int(11) NOT NULL,
  `meeting_id` int(11) NOT NULL,
  `checkin_time` varchar(100) DEFAULT NULL,
