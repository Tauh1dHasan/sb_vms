                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2" style="will-change: transform;">
                                                            <a class="dropdown-item action-view" href="{{ route('admin.receptionist.show', $employee->employee_id) }}">
                                                            ...
                                                            <a class="dropdown-item action-edit" href="{{ route('admin.receptionist.edit', $employee->employee_id) }}">
                                                            ...
                                                            <a class="dropdown-item action-edit" href="{{ route('admin.receptionist.editPassword', $employee->employee_id) }}">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>Change Password
                                                            </a>

                                                            <a class="dropdown-item action-delete" onclick="return confirm('Are you sure want to delete?')" href="{{ route('admin.receptionist.destroy', $employee->user_id) }}">
