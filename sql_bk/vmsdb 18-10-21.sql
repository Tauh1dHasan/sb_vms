...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2021 at 09:45 AM
...
CREATE TABLE `host_logs` (
  ...
  `modified_uese_id` int(11) DEFAULT NULL,
...
(23, 16, 9, 12, 2, 'Office visiting with four others', '2021-10-21 12:00:00', 4, NULL, NULL, 16, '2021-10-18 11:16:04', NULL, NULL, NULL, 0, 0, 0),
...
INSERT INTO `reception_logs` (`log_id`, `employee_id`, `user_id`, `user_type_id`, `first_name`, `last_name`, `gender`, `dob`, `eid_no`, `dept_id`, `designation_id`, `mobile_no`, `email`, `address`, `photo`, `nid_no`, `passport_no`, `driving_license_no`, `start_hour`, `end_hour`, `building_no`, `gate_no`, `floor_no`, `elevator_no`, `room_no`, `entry_user_id`, `entry_datetime`, `modified_uese_id`, `modified_datetime`, `description`, `log_type`, `status`) VALUES
(1, 15, 18, 3, 'New Receptionist updt', 'One updt', 1, '1990-01-01', 1234, 1, 11, '01577163339', 'tauhid.hasan1@sebpo.com', 'Karwarbazar', 'employee1632906228.jpg', '123456789', '123456789', '123456789', '10:00', '19:00', 'East Building', 'Gate 1', '1st Floor', 'Elevator 1', 'Room 1', 18, '2021-10-04 12:27:37', NULL, NULL, 'Reception profile update request', 2, 1);
