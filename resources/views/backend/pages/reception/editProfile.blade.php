    ...
    @section('content')
        ...
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb" style="background: none; padding: 0;">
                ...
                <li class="breadcrumb-item"><a href="{{ route('reception.editProfile', $employee->user_id) }}">Edit Profile</a></li>
            </ol>
        </nav>
                                            ...
                                            <div class="widget-content widget-content-area">
                                                <form action="{{ route('reception.updateProfile') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input name="mobile_no" type="number" class="form-control" id="mobile_no" value="{{ $employee->mobile_no }}" requried>
                                                    </div>
