                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2" style="will-change: transform;">
                                                            ...
                                                            <a class="dropdown-item action-edit" href="{{ route('admin.employee.editPassword', $employee->employee_id) }}">
                                                            ...
                                                            <a class="dropdown-item action-delete" onclick="return confirm('Are you sure want to delete?')" href="{{ route('admin.employee.destroy', $employee->user_id) }}">
