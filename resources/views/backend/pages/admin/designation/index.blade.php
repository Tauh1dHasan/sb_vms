                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.designation.index') }}">Departments</a></li>
                                    ...
                                    <tbody>
                                        @foreach($designations as $designation)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $designation->department ? $designation->department->department_name : ''}}</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2" style="will-change: transform;">
                                                            <a class="dropdown-item action-view" href="{{ route('admin.designation.show', $designation->designation_id) }}">
                                                            ...
                                                            <a class="dropdown-item action-edit" href="{{ route('admin.designation.edit', $designation->designation_id) }}">
                                                            ...
                                                            <a class="dropdown-item action-delete" onclick="return confirm('Are you sure want to delete?')" href="{{ route('admin.designation.destroy', $designation->designation_id) }}">
