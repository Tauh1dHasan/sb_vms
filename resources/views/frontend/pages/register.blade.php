							...
							<div class="col-md-12 col-lg-12 mb-5 mb-lg-0">
								<form action="{{route('frontend.user_registration')}}" id="frmSignIn" method="post" class="needs-validation" style="margin-top: 10px;" enctype="multipart/form-data" name="frmSignIn">
									...
									<div class="row">
										...
										<div class="form-group col-6">
											<label class="form-label text-color-dark text-3">Designation <span class="text-color-danger">*</label>
									...
									<div class="row">
										<div class="form-group col-12">
											<p class="text-3 mt-3" style="margin-bottom: 0;">
												<input type="checkbox" class="form-check-input" id="checkbox" style="margin-right: 8px" data-msg-required="Please accept terms and conditions." required name="agree"> 
												<label for="checkbox">
													Creating an account means you are accepting our <a href="#">Terms and Services</a> and <a href="#">Privacy Policy.</a>
												</label>
											</p>
										</div>
									</div>
