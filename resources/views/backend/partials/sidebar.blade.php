        ...
        <li class="menu">
            <a href="#dept" data-active="false" class="menu-toggle">
                <div class="base-menu">
                    ...
                    <span>Departments <br>& Designations</span>
                </div>
            </a>
        </li>
        @endif
            ...
            <li class="menu menu-single">
                <a href="{{ route('employee.rejectedMeetings') }}" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        ...
                        <span>Declined Appointments</span>
                    </div>
                </a>
            </li>
            @endif
...
<!-------------------------------------------  Admin Manage Host Submenu Start  -------------------------------------------->
        <div class="submenu" id="employee">
            <ul class="submenu-list menu-block-submenu" data-parent-element="#employee">
                ...
                <li class="menu-block">
                    <a href="{{route('admin.employee.pendingUpdate')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg> Pending Profile Updates </a>
                </li>
            </ul>
        </div>
...
<div class="submenu" id="receptionist">
    <ul class="submenu-list menu-block-submenu" data-parent-element="#receptionist">
        ...
        <li class="menu-block">
            <a href="{{route('admin.receptionist.pendingUpdate')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg> Pending Profile Updates </a>
        </li>
    </ul>
</div>
...
<!-------------------------------------------  Admin Manage Visitor Submenu Start  -------------------------------------------->
        <div class="submenu" id="visitor">
            <ul class="submenu-list menu-block-submenu" data-parent-element="#visitor">
                ...
                <li class="menu-block">
                    <a href="{{route('admin.visitor.create')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>Create Account</a>
                </li>
                <li class="menu-block">
                ...
                <li class="menu-block">
                    <a href="{{route('admin.visitor.pending')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>Pending Visitors</a>
                </li>
                <li class="menu-block">
                    <a href="{{route('admin.visitor.approved')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>Approved Visitors</a>
                </li>
                <li class="menu-block">
                    <a href="{{route('admin.visitor.blocked')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>Blocked Visitors</a>
                </li>
            </ul>
        </div>
...
<!-------------------------------------------  Admin Manage Roles & Permissions Submenu Start  -------------------------------------------->
<div class="submenu" id="role">
    <ul class="submenu-list menu-block-submenu" data-parent-element="#role">
        <li class="menu-block">
            <a href="{{route('admin.role.create')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg> Add Role </a>
        </li> 
        <li class="menu-block">
            <a href="{{route('admin.role.index')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg> All Roles </a>
        </li> 
        <li class="menu-block">
