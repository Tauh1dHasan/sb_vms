...
<!---------------------------------------------------  ADMIN HEADER TOP AREA END  ---------------------------------------------------->
                                    
<!---------------------------------------------------  EMPLOYEE HEADER TOP AREA START  ---------------------------------------------------->
                                            ...
                                            <ul class="navbar-item flex-row navbar-dropdown search-ul">
                                                ...
                                                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                                                    ...
                                                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                                                        ...
                                                        <div class="dropdown-item">
                                                            <a href="{{route('employee.editPassword')}}">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> <span> Update Password</span>
                                                            </a>
                                                        </div>
...
<!---------------------------------------------------  EMPLOYEE HEADER TOP AREA END  ---------------------------------------------------->

<!---------------------------------------------------  VISITOR HEADER TOP AREA START  ---------------------------------------------------->
...
<!---------------------------------------------------  VISITOR HEADER TOP AREA END  ---------------------------------------------------->

<!-----------------------------------------------  RECEPTION HEADER TOP AREA START  ----------------------------------------------->
