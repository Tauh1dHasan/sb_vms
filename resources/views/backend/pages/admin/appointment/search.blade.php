                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Searched Appointment Results</span></li>
                        </ol>
                    </nav>
                    ...
                    <div class="statbox widget box box-shadow">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                ...
                                                <select name="employee_id" id="" class="form-control select2">
                                                    ...
                                                    @else
                                                        @foreach ($employees as $emp)
                                                            <option value="{{ $emp->employee_id }}" {{$emp->employee_id == $employee ? 'selected' : ''}}>{{ $emp->first_name }} {{ $emp->last_name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="widget widget-card-four" style="padding-left: 0"> 
                                <div class="w-header">
                                    <div class="w-info">
                                        <h6 class="value">Searched Appointment Results</h6>
                                    </div>
                                </div>
                            </div>
