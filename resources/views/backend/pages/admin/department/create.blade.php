                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Add Department</span></li>
                        </ol>
                    </nav>
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <div class="widget widget-card-four" style="padding-left: 0"> 
                                <div class="w-header">
                                    <div class="w-info">
                                        <h6 class="value">Add Department</h6>
                                    </div>
                                </div>
                            </div>

                            <form class="" action="{{ route('admin.department.store') }}" method="post">
                                @csrf
                                <div class="input-group mb-4 col-md-6" style="padding-left: 0;">
                                    ...
                                    <input type="text" name="department_name" class="form-control" placeholder="Enter Department Name" aria-label="Department Name" required>
                                </div>
