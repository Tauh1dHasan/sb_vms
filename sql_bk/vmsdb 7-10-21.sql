...
(14, 16, 9, 12, 3, 'Project meeting with other developers', '2021-10-08 15:22:00', NULL, NULL, 16, '2021-10-07 09:22:34', NULL, NULL, NULL, 0, 0, 0),
(15, 16, 9, 12, 3, 'Project meeting with other developers', '2021-10-08 15:22:00', NULL, NULL, 16, '2021-10-07 09:23:17', 16, '2021-10-07 10:42:06', 'Time is not suitable', 4, 0, 0);
...
(7, 15, 16, 9, 12, 3, 'Project meeting with other developers', '2021/10/08 15:22', NULL, NULL, NULL, 0, NULL, 0, 16, '2021-10-07 09:23:17', 'Appointment placed from visitor panel', 6, 1),
(8, 15, 16, 9, 12, 3, 'Project meeting with other developers', '2021-10-08 15:22:00', NULL, NULL, 'Time is not suitable', 4, NULL, 0, 16, '2021-10-07 10:42:06', 'Appointment canceled by visitor', 4, 1);
...
CREATE TABLE `visitors` (
  ...
  `modified_user_id` int(11) DEFAULT NULL,
  `modified_datetime` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `visitor_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=pending, 1=approved, 2=declined'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
