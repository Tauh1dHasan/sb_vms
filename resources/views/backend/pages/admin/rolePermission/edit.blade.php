                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Edit {{ $rolePermission->user_type->user_type_name }}'s Permission</span></li>
                        </ol>
                    </nav>
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <div class="widget widget-card-four" style="padding-left: 0"> 
                                <div class="w-header">
                                    <div class="w-info">
                                        <h6 class="value">Edit Roles Permission</h6>
                                    </div>
                                </div>
                            </div>

                            <form class="" action="{{ route('admin.rolePermission.update', $rolePermission->user_permission_id) }}" method="post">
                                @csrf
                                @method('patch')
                                ...
                                <div class="input-group mb-4 col-md-6" style="padding-left: 0;">
                                    ...
                                    <select class="form-control" name="user_type_id">
                                        <option value="{{ $rolePermission->user_type_id }}" disable>{{ $rolePermission->user_type->user_type_name }}</option>
                                    </select>
                                </div>
                                    ...
                                    <div class="col-md-12" style="padding-left: 0;">
                                        <div class="n-chk">
                                            <label class="new-control new-checkbox new-checkbox-text checkbox-success">
                                                ...
                                                <input type="checkbox" name="permission_id[]" class="new-control-input" value="{{ $permission->permission_id }}" {{ ($permission->permission_id == $rolePermission->permission_id) ? 'checked' : '' }}>
