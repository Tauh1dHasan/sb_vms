                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.employee.index') }}">Manage Receptionists</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><span>Pending Receptionists</span></li>
                        </ol>
                    </nav>
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <div class="widget widget-card-four" style="padding-left: 0"> 
                                <div class="w-header">
                                    <div class="w-info">
                                        <h6 class="value">Pending Receptionists</h6>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach($employees as $employee)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('admin.approve.receptionist', $employee->user_id)}}" class="btn btn-success btn-sm d-block">Approve</a>
                                                    <a href="{{route('admin.decline.receptionist', $employee->user_id)}}" class="btn btn-danger btn-sm mt-2 d-block">Decline</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
