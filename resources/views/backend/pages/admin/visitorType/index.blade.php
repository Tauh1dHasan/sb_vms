                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: none; padding: 0;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>All Visitor Types</span></li>
                        </ol>
                    </nav>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2" style="will-change: transform;">
                                                            <a class="dropdown-item action-view" href="{{ route('admin.visitorType.show', $visitor_type->visitor_type_id) }}">
                                                            ...
                                                            <a class="dropdown-item action-edit" href="{{ route('admin.visitorType.edit', $visitor_type->visitor_type_id) }}">
                                                            ...
                                                            <a class="dropdown-item action-delete" onclick="return confirm('Are you sure want to delete?')" href="{{ route('admin.visitorType.destroy', $visitor_type->visitor_type_id) }}">
